    ...
    <div className='characters-manager'>
      ...
      <div className='characters-manager__grid'>
        {disneyCharacters.map(character => <Character
          ...
          character={character}
          handleClick={(newCharacterDetailId) => setCharacterDetailId(newCharacterDetailId)}
        ></Character>)}
      </div>
      ...
      {characterDetailInfo
        ? <CharacterDetail character={characterDetailInfo} handleClick={(newCharacterDetailId) => {
